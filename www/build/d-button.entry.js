...
const DButton = class {
    ...
    render() {
        ...
        // 允许外部传递style和class
        return (h(Host, { key: 'a0365687a75a32d1911e4551a170c52223852bbc' }, h("button", { key: '65bf0e826930ca708155db8978c80417e9707ae5', class: classes, disabled: this.disabled, style: this.customStyle, part: "button" }, h("slot", { key: '82fd860fad0a5cd6191d347a690e78904e335a2b' }))));
    }
};
