...
const DBacktop = class {
    ...
    render() {
        return (h(Host, { key: '88314091f8ac1d20f664087d9d8dd969ee4b5db9' }, h("div", { key: '2d3d4a1268739024e246899716336959269cbe40', class: `d-backtop ${this.visible ? "d-backtop--visible" : ""}`, style: {
                right: this.right,
                bottom: this.bottom,
            }, onClick: this.handleClick }, h("slot", { key: '174757fd840c303d6068b8b82ad5fa6385a57aaf' }))));
    }
};
